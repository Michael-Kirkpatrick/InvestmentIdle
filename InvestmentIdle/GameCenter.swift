...
//        // take score
//        let score = GKLeaderboard.Entry(leaderboardIdentifier: leaderboardID)
//        // set value for score
//        score.value = Int64(value)
//        // push score to Game Center
        self.leaderboard?.submitScore(value, context: value, player: self.localPlayer) {error in
            // check for errors
            if error != nil {
...
//                            if leaderboard.identifier == self?.leaderboardID {
                    self?.leaderboard = leaderboards![0]
                    finished()
//                            }
//                        }
//                    }
